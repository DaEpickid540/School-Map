...
export const STAIR_NODES = new Set([
  "A_Stair", "B_Stair", "C_Stair", "Z_Stair",   // primary pod stairs
  "Z2", "A2", "B2",                               // cross-pod connector stairs
...
export const schoolGraph = {
  ...
  //   Lobby_1 contains A11 (front desk) and admin rooms A14-A32
...
const ADMIN_F1 = ["A11","A14","A15","A16","A17","A18","A19","A20","A21","A22",
...
const ADMIN_F2 = ["A51A","A51B","A52","A53","A53A","A53B","A53C","A53D",
...
for (const room of ADMIN_F2) {
  ...
  if (!schoolGraph["Lobby_2"]) schoolGraph["Lobby_2"] = ["A_Pod_2", "C_Pod_2", "Front_Stair"];
